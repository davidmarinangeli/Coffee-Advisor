...
const stringsolutions = ['Ecco le soluzioni. Quali vuoi vedere?', 'Ho trovato queste capsule. Quali vuoi vedere?', 'Ho trovato queste soluzioni basandomi sulla tua richiesta. Quali vuoi vedere?'];
const solutions = [
  '<speak>\n' +
    '  <par>\n' +
...
const buyIt = 'Esplora il prodotto originale';
...
const notsupported = 'Mi dispiace, l\'acquisto tramite Google Home non è ancora supportato';
