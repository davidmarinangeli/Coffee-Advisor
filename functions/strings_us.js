...
const populartoken = 'us/nespresso%20compatible%20originalline/relevancerank';
...
const stringsolutions = ['I have found these solutions. Which one would you like to see?', 'Okay, I have found these solutions basing on your request. Which one would you like to see? ', 'I think you will like these solutions. Which one would you like to see? '];
const solutions = [
  '<speak>\n' +
    '  <par>\n' +
...
const pricesFrom = 'Prices start from ';
...
const welcomeSuggestions = ['Popular capsules', 'Recommended capsules', 'Strong coffee', 'What can you do?'];
const otherSolutions = ['Show popular capsules', 'No'];
const buyIt = 'Explore the original product';

const context = 'Sorry, I can show you the results only on a device with a display.';
const notification = 'Here are the solutions of your search';
const notsupport = 'I am sorry, the purchase of goods through Google Home is not supported yet';
